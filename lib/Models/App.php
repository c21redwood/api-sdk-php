...
'edit' => 'edit'    ];
    ...
    protected static $setters = [
        'icon' => 'setIcon',
'name' => 'setName',
'sso_connection' => 'setSsoConnection',
'sso_id' => 'setSsoId',
'link' => 'setLink',
'edit' => 'setEdit'    ];
    ...
    protected static $getters = [
        'icon' => 'getIcon',
'name' => 'getName',
'sso_connection' => 'getSsoConnection',
'sso_id' => 'getSsoId',
'link' => 'getLink',
'edit' => 'getEdit'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['sso_connection'] = isset($data['sso_connection']) ? $data['sso_connection'] : null;
        $this->container['sso_id'] = isset($data['sso_id']) ? $data['sso_id'] : null;
     ...
     * @return string
     */
    public function getSsoConnection()
    {
        return $this->container['sso_connection'];
    }

    /**
     * Sets sso_connection
     *
     * @param string $sso_connection sso_connection
     *
     * @return $this
     */
    public function setSsoConnection($sso_connection)
    {
        $this->container['sso_connection'] = $sso_connection;
