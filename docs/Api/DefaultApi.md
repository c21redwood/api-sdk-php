...
[**guideConnectionIdGet**](DefaultApi.md#guideConnectionIdGet) | **GET** /guide/{connection}/{id} | Get a guide based on its connection reference
...
# **guideConnectionIdGet**
> \Redwood\Models\Guide guideConnectionIdGet($connection, $id)
